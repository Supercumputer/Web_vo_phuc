...
<div class="box_tite mb-3">Quản lý thùng rác</div>
...
<div class="box_table my-3">
    ...
    <div class="box_btn">
        ...
        <form action="index.php" method="GET" class="mb-0">
            <input type="hidden" name="status_trash" value="1">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr style="vertical-align: middle;">
                    <th scope="col">
                        <input class="form-check-input" name="input_item" type="checkbox" value="<?= $product_id?>" data_id="<?= $product_id ?>" data_name="destroy">
                    <th>
                    ...
                    <td>
                        <div class="icon_btn">
                            <a class="btn_show" data-bs-toggle="modal" data-bs-target="#exampleModal" data="<?= $product_id?>" data_id="<?= $product_id ?>" data_name="destroy"><i class="fa-solid fa-trash-can"></i></a>
                            <a href="index.php?btn_edit=<?= $product_id?>&status_trash=<?= $status_trash?>"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a href="index.php?manager_sp=<?= $product_id?>"><i class="fa-brands fa-dropbox"></i></i></a>
                            <a href="index.php?btn_restore=<?= $product_id?>"><i class="fa-solid fa-trash-arrow-up"></i></i></a>
                        </div>
                    </td>
                </tr>
                <?php endforeach ?>
        ...
        <div class="d-flex flex-row-reverse pe-3">
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <?php if($page > 1) : ?>
                        <li class="page-item">
                            <a class="page-link linkm" href="index.php?<?= isset($keyword) ? 'key='.$keyword.'&status_trash=1' : 'list_trash'?>&page=<?= $page - 1?>">
                    ...
                    <?php for($i = 1 ; $i <= $total_pages ; $i++) : ?>
                        <li class="page-item"><a class="page-link linkm" href="index.php?<?= isset($keyword) ? 'key='.$keyword.'&status_trash=1' : 'list_trash'?>&page=<?= $i?>"><?= $i?></a></li>
                    <?php endfor ?>
