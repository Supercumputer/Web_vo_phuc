    ...
    <div class="box_wap mx-3 py-2">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <?php for($i = 0; $i < sizeof($list_category); $i++){ 
                    extract($list_category[$i]);
                    if($category_id == 1){
                        continue;
                    }
                ?>
                    <tr style="vertical-align: middle;">
                        <th scope="col">
                            <input class="form-check-input" name="input_item" type="checkbox" value="<?= $category_id?>" >
                        <th>
                        <td scope="row" class="id_column"><?= $i?></td>
                        <td><?= $category_name?></td>
                        <td>
                            <div class="d-flex gap-2 align-items-center">
                                <img src="<?=$UPLOAD_URL.'/'.$category_img?>" width="50" alt="">
                                <span><?= $category_img?></span>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="icon_btn">
                                <a class="btn_show" data-bs-toggle="modal" data-bs-target="#exampleModal" data="<?= $category_id?>"><i class="fa-solid fa-trash-can"></i></a>
                                <a href="index.php?btn_edit=<?= $category_id?>"><i class="fa-solid fa-pen-to-square"></i></a>
                            </div>
                        </td>
                    </tr>
                <?php } ?>
