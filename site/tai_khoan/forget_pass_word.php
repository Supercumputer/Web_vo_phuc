<div class="box_conten_lg d-flex col-xl-7 col-lg-9 col-md-10 col-11 align-items-center">
    ...
    <div class="box_form col-sm-7 col-12">
        ...
        <p class="name_ac mb-3">Quên mật khẩu</p>
        <form class="row g-3" action="index.php?forget_pass_word" method="post" id="form">
            <div class="col-md-12">
                <input type="email" class="form-control" placeholder="Email" name="email">
            </div>

            <div class="col-12 text-center">
                <button type="submit" class="btn btn-danger col-4">Tìm lại mật khẩu</button>
            </div>
